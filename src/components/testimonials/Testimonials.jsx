...
const data = [
  {
    avatar: AVTR3,
    name: 'Andres David Varela Lopez',
    text: "Saraí es una trabajadora increible, en general, siempre es muy dedicada en cada trabajo en el que está, ella es muy organizada, muy centrada y siempre se pone al frente de todo, es muy correcta en todo y cada dia intenta superarse y mejorar.",
    contacto: "developer.andvarlop@gmail.com"
  },/*
  {
    avatar: AVTR1,
...
const testimonials = () => {
  return (
    <section id='testimonials'>
      ...
      >
        {
          data.map(({ avatar, name, text, contacto }, index) => {
            return (
              <SwiperSlide key={index} className="testimonial">
                ...
                <br />
                <h3>Contacto</h3>
                <small className='Client__review'>{contacto}</small>
              </SwiperSlide>
            )
          })
        }
